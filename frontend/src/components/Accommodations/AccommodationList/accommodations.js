...
import AccommodationLowerAvailableNights from '../AccommodationRent/accommodationRent';
                    ...
                    <div className="col mb-3">
                        <div className="row">
                            <div className="col-sm-12 col-md-12">
                                <Link className="btn btn-secondary btn-block" to="/accommodations/add">Add New Accommodation</Link>
                            </div>
                        </div>
                    </div>
                </div>
